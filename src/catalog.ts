...
export const DATASET_CATALOG: DatasetEntry[] = [
  ...
  { filename: 'J_TEST36.DAT', title: 'Black-and-White Flower', classification: 'Five-Lobed Attractor', dynamicsNote: 'Compact petals around a dark central basin', reC: -0.12, imC: 0.74, xMin: -1.8, xMax: 1.8, yMin: -1.8, yMax: 1.8, maxIters: 72 },
  { filename: 'J_TEST37.DAT', title: 'Branched Lightning', classification: 'Dendritic Boundary', dynamicsNote: 'Fine branching filaments with a crisp tree silhouette', reC: -0.123, imC: 0.745, xMin: -1.7, xMax: 1.7, yMin: -1.7, yMax: 1.7, maxIters: 100 },
  ...
  { filename: 'J_TEST42.DAT', title: 'Four-Arm Pinwheel', classification: 'Quarter-Turn Spiral', dynamicsNote: 'Four broad arms turning around a compact center', reC: 0.285, imC: 0.01, xMin: -1.5, xMax: 1.5, yMin: -1.5, yMax: 1.5, maxIters: 130 },
  ...
  { filename: 'J_TEST45.DAT', title: 'Inkblot Dendrite', classification: 'Pure Branching Form', dynamicsNote: 'Organic inkblot silhouette made from recursive branches', reC: 0, imC: 1, xMin: -1.6, xMax: 1.6, yMin: -1.6, yMax: 1.6, maxIters: 140 }
];
